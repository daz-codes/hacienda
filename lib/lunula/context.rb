...
module Lunula
  class Context
    ...
    def navigation_request?
      request.get_header("HTTP_X_LUNULA_NAVIGATION") == "true"
    end

    def prefetch?
      request.get_header("HTTP_X_LUNULA_PREFETCH") == "true"
    end
    ...
    def cache
      application&.cache || Lunula.cache
    end

    def storage
      application&.storage || Lunula.storage
    end
