...
Sequel.migration do
  change do
    alter_table(:hacienda_jobs) do
      ...
      add_index :unique_key, name: :hacienda_jobs_unique_key
      add_index :concurrency_key, name: :hacienda_jobs_concurrency_key
      add_index :blocked_at, name: :hacienda_jobs_blocked
    end
  end
end
